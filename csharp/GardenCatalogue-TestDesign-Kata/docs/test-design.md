...
* Use NUnit
* Structure the test into three parts: Arrange, Act, Assert. Do not separate sections with comments like `// Arrange`, use a blank line either side of the Act step.
